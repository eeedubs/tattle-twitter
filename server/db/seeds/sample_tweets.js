  ...
  return knex('tweets').del()
    .then(function () {
      ...
      return knex('tweets').insert([
        {id: 1, messages: "Today's tasks: 1) chase stick, then chase tail; 2) receive many scratches from human; 3) bark at the mail man.", image_url: 'https://secure.i.telegraph.co.uk/multimedia/archive/02603/stick-dog_2603828b.jpg'},
        ...
        {id: 3, messages: 'Finn. Noggin. Duuuuuuuuuuuude.', image_url: 'https://cdn3.webdamdb.com/1280_InuodxVApHQ3.jpg?1528680850'}
      ]);
    });
};
